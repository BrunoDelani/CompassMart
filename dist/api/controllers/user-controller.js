...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.findUser = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var users, BadRequest_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, user_service_1["default"].findUser(req.query)];
                    case 1:
                        users = _a.sent();
                    ...
                    case 2:
                        ...
                        if (BadRequest_1 instanceof users_not_found_1["default"])
                            return [2 /*return*/, res.status(BadRequest_1.statusCode).json({ BadRequest: BadRequest_1 })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (BadRequest_2 instanceof user_email_exists_1["default"])
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (BadRequest_3 instanceof user_not_found_1["default"])
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, user_service_1["default"].authenticateUser(req.body)];
                    case 1:
                        result = _a.sent();
                    ...
                    case 2:
                        ...
                        if (BadRequest_4 instanceof user_incorrect_password_1["default"])
                            return [2 /*return*/, res.status(BadRequest_4.statusCode).json({ BadRequest: BadRequest_4 })];
                        if (BadRequest_4 instanceof user_not_found_1["default"])
                            return [2 /*return*/, res.status(BadRequest_4.statusCode).json({ BadRequest: BadRequest_4 })];
