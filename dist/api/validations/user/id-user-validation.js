...
var user_id_invalid_1 = __importDefault(require("../../../errors/user/user-id-invalid"));
    ...
    return __generator(this, function (_a) {
        try {
            ...
            if (BadRequest instanceof user_id_invalid_1["default"])
                return [2 /*return*/, res.status(BadRequest.statusCode).json({ BadRequest: BadRequest })];
            return [2 /*return*/, res.status(400).json(BadRequest)];
        }
        return [2 /*return*/];
    });
}); });
