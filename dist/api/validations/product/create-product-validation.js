...
exports["default"] = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var ProductValidationSchema, error, BadRequest_1;
        ...
        switch (_a.label) {
            case 0:
                ...
                ProductValidationSchema = joi_1["default"].object({
                    ...
                    qtd_stock: joi_1["default"].number().min(product_rules_1["default"].minStockToRegister).max(product_rules_1["default"].maxStock).required(),
                    bar_codes: joi_1["default"].string().trim().length(product_rules_1["default"].barCodesLength).required()
                });
