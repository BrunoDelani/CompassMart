...
exports.default = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const ProductValidationSchema = joi_1.default.object({
            ...
            price: joi_1.default.number().min(product_rules_1.default.minPrice).max(product_rules_1.default.maxPrice),
            qtd_stock: joi_1.default.number().min(product_rules_1.default.minStock).max(product_rules_1.default.maxStock)
        });
