...
var ProductService = /** @class */ (function () {
                        ...
                        insertValues = function (mMap, pMap, type, optional, newProductFromatter) {
                            ...
                            for (var index = 0; index <= (mMap.length - 1); index++) {
                                ...
                                if (mMap[index] !== mMap[mMap.length - 1]) {
                                    ...
                                    valueField = (_b = {}, _b[mMap[index]] = _this.formatterValue(result[pMap.toString()], type, optional), _b);
                                    return valueField;
                                }
                            }
                            ;
    ...
    ProductService.prototype.formatterValue = function (value, type, optional) {
    ...
    ProductService.prototype.insertListProductsCSV = function (csvFormated) {
        ...
        var _b;
        return __awaiter(this, void 0, void 0, function () {
            var insertProducts, listResult, element, newProduct, verify, e_1_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 13:
                        ;
                        return [4 /*yield*/, product_repository_1["default"].insertMany(insertProducts)];
                    case 14:
                        _c.sent();
